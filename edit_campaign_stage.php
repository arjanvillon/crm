...
<div class="loader">
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li><a href="#">Edit Campaign Stage</a></li>
						</ul>
               ...
               <div class="span12">
                  <div class="portlet box red">
                     ...
                     <div class="portlet-body form">
                        <form id="edit_campaign_stage_validate" action="save_edited_campaign_stage.php?id=<?=$id?>" method="post" class="form-horizontal" >
                       ...
                       <!---  <input name="id" type="hidden" value="" /> --->   
                         <div class="row-fluid">
                              ...
                              <div class="controls">
                                      <input id="csname" maxlength="30" minlength="5" spellcheck="true" name="csname" type="text" class="span10 m-wrap" value="<?=$row['campaign_stage_name_str']?>" required>
                              </div>
                           </div>
                                   <div class="control-group">
                              <label class="control-label" for="csorder" title="Required">Campaign Stage Order<span class="required" title="Required">*</span></label>
                              <div class="controls">
                                      <input name="csorder" id="csorder" maxlength="30" spellcheck="true" type="text" class="span10 m-wrap" value="<?=$row['campaign_stage_order_str']?>" required>
                              </div>
                           </div>
                           ...
                           <div class="control-group">
                              ...
                              <div class="controls ">
                                 ...
                                 <option value="<?=$row['campaign_stage_status_idr']?>" selected="selected"><?=$row['campaign_stage_status_idr']?></option>
                            ...
                            <div class="control-group">
                              ...
                              <div class="controls">
                                   ...
                                   <option value="<?=$row['default_activity_status_idr']?>" selected="selected"><?=$row['default_activity_status_idr']?></option>
                              ...
                              <div class="controls ">
                                  <input id="csemail" spellcheck="true" name="csemail" type="email" class="span10 m-wrap" value="<?=$row['cs_email_eml']?>" required>       
                              </div>
                           </div>
                              ...
                              <div class="controls span6">
                                 <textarea id="csnotes" maxlength="100" spellcheck="true" name="csnotes" rows="6" class="span12 m-wrap"></textarea>
                              </div>
                           </div>                                         
                              ...
                              <div class="form-actions clearfix">
                                <!--MAGLALAGAY BA AKO NG CANCEL BUTTON?-->
                                 <a href="view_campaign_stages.php?id=<?=$id?>" class="btn button-previous">
                                 <i class="m-icon-swapleft"></i> Cancel
                                 </a>
                                
                                 <input type="submit" value="Submit" name="edit7" class="btn red button-submit"><i class="m-icon-swapright m-icon-white"></i>
                              </div>
 ...
 <script>
$().ready(function() {
	$("#edit_campaign_stage_validate").validate();
});
</script>   
