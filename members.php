					...
					<div class="span12">
						...
						<div class="portlet box red">
							<div class="portlet-title">
								<h4 style="color: #fff"><i class="icon-reorder"></i>Manage Members</h4>
								<div class="tools">
							...
							<div class="portlet-body">
								...
								<table class="table table-striped table-hover table-bordered" id="campaigns_table">
									...
									<tbody>
										...
										<?php 
											$sql = mysqli_query($conn, "SELECT id,campaign_name_str, active_bol,campaign_status_idr, lead_ctr,contact_ctr,total_lead_contact_ctr FROM tbl_campaign");
											while($row = $sql->fetch_assoc()){
											echo "<tr class='odd gradeX'>
											<td><a class='popovers' data-trigger='hover' data-placement='top' data-content='View members in this campaign' href='view_campaign_members.php?id=".$row["id"]."'>" . $row['campaign_name_str'] . "</a></td>
											<td>";
												if($row['active_bol']==1){
											...
											<td class='center hidden-480'>" . $row['lead_ctr'] .  "</td>
											<td class='center'>" . $row['contact_ctr'] . "</td>
											<td class='center'>" . $row['total_lead_contact_ctr'] . "</td>
											</tr>";
											}
