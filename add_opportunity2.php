...
<div class="loader">
               ...
               <div class="span12">
                  <div class="portlet box red">
                     ...
                     <div class="portlet-body form">
                        <form id="add_opportunity2_validate" action="save_opportunity.php?id=<?=$id?>" method="post" class="form-horizontal">
                      			<div class="row-fluid">
                              ...
                              <div class="controls">
                                 <input spellcheck="true" maxlength="30" minlength="5" id="oname" name="oname" type="text" class="span6 m-wrap" required>
                              </div>
                           </div>
                            ...
                            <div class="control-group">
                            	<label class="control-label" for="date" title="Required">Close Date<span class="required" title="Required">*</span></label>
                            			  <div class="controls">
                                    		<div class="row-fluid">
											 <div class="span6">
												<input required class="span12" type="date" id="date" name="date" max="2050-12-31" />
										 	</div>
                                    	   </div>                             
                            			  </div>
                             		  </div>                             
                           ...
                           <div class="control-group">
                              <label class="control-label" for="ns" title="Optional">Next Step</label>
                              <div class="controls">
                                 <input spellcheck="true" id="ns" maxlength="30" name="next_step" type="text" class="span6 m-wrap">
                              </div>
                           </div>
                           
                             <div class="control-group">
                              <label class="control-label" for="fc" title="Required">Forecast<span class="required" title="Required">*</span></label>
                              <div class="controls">
                                <select id="fc" name="forecast" class="chosen span6 m-wrap" data-placeholder="Choose Forecast" tabindex="1" required>
                           ...
                           <div class="control-group">
                              <label class="control-label" for="probab" title="Required">Probability<span class="required" title="Required">*</span></label>
                              <div class="controls">
                                <select id="probab" name="probability" class="chosen span6 m-wrap" data-placeholder="Choose Probability" tabindex="1">
								   ...
								   <option value="100">100</option>
                                     ...
                                     <div class="control-group">
                              <label class="control-label" title="Optional" for="comp">Competitor</label>
                              <div class="controls">
                                 <input spellcheck="true" id="comp" maxlength="30" name="competitor" type="text" class="span6 m-wrap">
                              </div>
                           </div>
                              ...
                              <div class="controls">
                                 <div class="danger-toggle-button">
                                    <input id="rep" name="decision" type="checkbox" class="toggle" checked="checked" />
                                 </div>
                              ...
                              <div class="controls">
                               ...
                               <div class="control-group">
                              <label class="control-label">Campaign<span class="required" title="Required">*</span></label>
                              <div class="controls">
                                <select name="campaign" class="chosen span6 m-wrap" data-placeholder="Choose Campaign" tabindex="1" required>
								  <?php 
									$sql2 = mysqli_query($conn,"SELECT id, campaign_name_str FROM tbl_campaign");
									while ($row = $sql2->fetch_assoc()){
									 	$id2= $row['id'];
									  $name2 = $row['campaign_name_str']; 
									  echo '<option selected="selected" value="'.$id2.'">'.$name2.'</option>';
									}
							 		mysqli_close($conn);
									?> 
                              </select>
                              ...
                              <div class="controls">
                                 <textarea spellcheck="true" id="wl" maxlength="300" name="report" class="col-lg-7 m-wrap span6"></textarea>
                              </div>
                           </div>
 ...
 <script>
$().ready(function() {
	$("#add_opportunity2_validate").validate();
});
</script>      
 <script>
	var ctr=0;
