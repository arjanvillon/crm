	...
	function selectquart(){
		 ...
		 var y = document.getElementById("selyear").value;
			if (x == "First Quarter"){
				var startq = "-01-01";
				var finishq = "-03-31";
				window.location.href ="reports_campaign.php?start=" + y + startq + "&finish=" + y + finishq;	
			}
	...
	function selectmonth(){
		 ...
		 var y = document.getElementById("selyear").value;
			if (x == "January"){
				var startq = "-01-01";
				var finishq = "-01-31";
				window.location.href ="reports_campaign.php?start=" + y + startq + "&finish=" + y + finishq + "&active=1";	
			}
			else if (x == "February"){
				var startq = "-02-01";
				var finishq = "-02-28";
