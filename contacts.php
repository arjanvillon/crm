...
<div class="loader">
					...
					<div class="span12">
						...
						<div class="portlet box red">
							<div class="portlet-title">
								<h4><i class="icon-reorder"></i>Manage Contacts</h4>
								<div class="tools">
							...
							<div class="portlet-body">
								<div class="clearfix">
									<div class="btn-group">
									<a class="btn btn red" href="add_contact.php">
										<i class="icon-plus"></i> Add New 
										</a>
									</div>
									<div class="btn-group pull-right">
									<input type="submit" value="Delete" name="delete2" class="btn button-next"><i class="m-icon-swapright m-icon-white"></i>
									</div>
								</div>
						
								<table class="table table-striped table-hover table-bordered" id="contact_table" >
									<thead>
										<tr>
									...
									<?php 
										...
										$sql = mysqli_query($conn, "SELECT tbl_account.account_name_str, tbl_account.id as account_id, tbl_contacts.id as contact_id, job_title_str, first_str, account_idr, email_eml, tbl_contacts.phone_str as contact_phone, mobile_str, department_str FROM tbl_contacts INNER JOIN tbl_account ON tbl_contacts.account_idr= tbl_account.id");//You don't need a ; like you do in SQL

										while($row=$sql->fetch_assoc()){  ?> 
										<tr class="odd gradeX">
										<td><input type="checkbox" name="ccheck[]" value="<?=$row["contact_id"]?>"</td>
										<td><?=$row["job_title_str"]?></td>
										<td><a class="popovers" data-trigger="hover" data-placement="top" data-content="Edit this contact" href="view_contact.php?id=<?=$row["contact_id"]?>"><?=$row["first_str"]?></td>
										...
										<td class="center hidden-480"><?=$row["email_eml"]?></td>
										<td class="center"><?=$row["contact_phone"]?></td>
										<td class="center hidden-480"><?=$row["mobile_str"]?></td>
										<td class="hidden-480"><?=$row["department_str"]?></td>
										</tr> <?php
										}
	...
	$('input[type=submit]').load(function(){
			  $('.loader').fadeOut();
		});
	</script>
</body>
