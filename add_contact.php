               ...
               <div class="span12">
                  <div class="portlet box red" >
                     ...
                     <div class="portlet-body form">
                        <form action="save_contact.php" id="contacts_validate" method="post" class="form-horizontal">
            	 ...
            	 <div class="control-group">
                       ...
                       <div  class="scrollspy-example"  >
                        <h3 id="scroll1" class="form-section">Details</h3>
							 <div class="control-group">
                               <label class="control-label" title="Required">Account Name<span title="Required" class="required">*</span></label> 
                              <div class="controls">
