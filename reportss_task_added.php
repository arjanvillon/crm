               ...
               <div class="span12">
                  <div class="tabbable tabbable-custom boxless">
                     <ul class="nav nav-tabs">
                        ...
                        <li class="active"><a class="advance_form_with_chosen_element" href="#task_tab" data-toggle="tab">Task Report</a></li>
								...
								<div class="row-fluid">
									<div class="span12">
										...
										<div class="tabbable tabbable-custom">
											...
											<div id="task_added" style="width: 100%; height: 400px">
										...
										<div id="task_added" style="width: 100%; height: 360px;">
													<div style="screen"><center><h2>&nbsp;You haven't selected a specific year and month</h2><h3>&nbsp;Please select a year and a month</h3></center></div>
	...
	function selectquart(){
		 ...
		 var y = document.getElementById("selyear").value;
			if (x == "First Quarter"){
				var startq = "-01-01";
				var finishq = "-03-31";
				window.location.href ="reportss_task_added.php?start=" + y + startq + "&finish=" + y + finishq;	
			}
	...
	function selectmonth(){
		 ...
		 var y = document.getElementById("selyear").value;
			if (x == "January"){
				var startq = "-01-01";
				var finishq = "-01-31";
				window.location.href ="reportss_task_added.php?start=" + y + startq + "&finish=" + y + finishq + "&active=1";	
			}
			else if (x == "February"){
				var startq = "-02-01";
				var finishq = "-02-28";
...
function drawAxisTickColors() {
      var data = google.visualization.arrayToDataTable([
		['Accounts', 'Task/s Added', 'Task/s Completed', 'Task/s Not Completed'],
       <?php
		$sql1= mysqli_query($conn,"SELECT * FROM tbl_account");
		while($row1 = $sql1->fetch_assoc()){
		$id1= $row1["id"];
		$sql2 = mysqli_query($conn,"SELECT * FROM tbl_tasks WHERE (account_idr ='" .$id1."') AND (task_date_dat BETWEEN '".$start."' AND '".$finish."')");
		$total=0;
		$total1=0;
		$total2=0;
		while($row2=$sql2->fetch_assoc()){
			$total++;
			if ($row2['task_status_idr'] == 'Completed'){
				$total1++;
			}
			else {
				$total2++;
			...
			echo "['" .$row1["account_name_str"]. "'," .$total. "," .$total1. "," .$total2. "],";
		}
		mysqli_close($conn);
				?>
      ]);
      ...
      var options = {
        title: 'Tasks Report <?php echo " from " . $start ." to ". $finish;?>',
      ...
      var chart = new google.visualization.BarChart(document.getElementById('task_added'));
