										...
										<div class="tabbable tabbable-custom">
											...
											<div id="opps_won/lost" style="width: 100%; height: 360px;">
													...
													<h2>&nbsp;You haven't selected a specific year and quarter</h2>
														<h3>&nbsp;Please select a year and a quarter</h3></div></center>
	...
	function selectquart(){
		 ...
		 var y = document.getElementById("selyear").value;
			if (x == "First Quarter"){
				var startq = "-01-01";
				var finishq = "-03-31";
				window.location.href ="reportss.php?start=" + y + startq + "&finish=" + y + finishq;	
			}
	...
	function selectmonth(){
		 ...
		 var y = document.getElementById("selyear").value;
			if (x == "January"){
				var startq = "-01-01";
				var finishq = "-01-31";
				window.location.href ="reportss.php?start=" + y + startq + "&finish=" + y + finishq + "&active=1";	
			}
			else if (x == "February"){
				var startq = "-02-01";
				var finishq = "-02-28";
...
<script>
 var rept= document.getElementById('report_t');
	...
	repc.addEventListener('click', function(){
		document.location.href = 'reportss_campaign.php';
	});
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ...
          <?php 
				...
				$sql = mysqli_query($conn, "SELECT account_name_str, address_lng, city_str, country_idr, postcode_int, phone_str, website_str, notes_lng, account_type_idr, owner_idr, task_ctr, task_completed_ctr FROM tbl_account"); //You don't need a ; like you do in SQL
