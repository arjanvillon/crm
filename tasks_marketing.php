		...
		<li class=" has-sub">
				...
				<li class="has-sub active">
					...
					<ul class="sub">
						...
						<li  class="selected active"><a href="tasks_marketing.php">Tasks</a></li>
						...
						<div class="portlet box red">
							...
							<div class="portlet-body">
								<div class="clearfix">
									...
									<input type="submit" value="Delete" name="delete5" class="btn button-next"><i class="m-icon-swapright m-icon-white"></i>
									</div>
								</div>
