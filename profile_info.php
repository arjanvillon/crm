...
<div class="loader">
					...
					<div class="span12">
						...
						<div class="tabbable tabbable-custom">
							...
							<div class="tab-content">
								<div class="active tab-pane profile-classic row-fluid" id="tab_1_2">
									<div class="span2">
										<center><img src="data:image/jpeg;base64,<?php echo base64_encode($row1['name'] ) ?>" onerror="this.src='assets/img/avatar1.png'" height="200" width="200" class="img-thumnail" /></center></div>
									<ul class="unstyled span10">
								
										<li><span>User Name:</span> <?=$_SESSION["uname"]?></li>
										<li><span>First Name:</span> <?php
																		if (empty($row["firstp_str"])){
																			echo("-");
																		}
																		else {
																			echo $row["firstp_str"];
																	...
																	?></li>
										<li><span>Last Name:</span><?php
																		if (empty($row["lastp_str"])){
																			echo("-");
																		}
																		else {
																			echo $row["lastp_str"];
										...
										<li><span>Website Url:</span>
										<?php
																		if (empty($row["websitep_str"])){
																			echo("-");
																		}
																		else {
																			?> <a target="_blank" href="<?=$row['websitep_str']?>">
																			<?php echo $row["websitep_str"]; ?> </a> <?php
																		}
																	?>
										</li>
 ...
 var rept= document.getElementById('overview');
	var repc= document.getElementById('accountp');
